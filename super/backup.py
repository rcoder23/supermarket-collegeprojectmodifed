...
class Bill_App:
    ...
    def __init__(self, root):
        ...
        exit_btn = Button(F61, command=self.exit, text="EXIT", fg="white", bg="teal",
                          font=("times new roman", 14, "bold"), bd=5, relief=GROOVE, width=8, height=1).grid(row=0,
                                                                                                             ...
                                                                                                             padx=8,
                                                                                                             pady=23)
        admin_btn = Button(F61, command=self.admin, text="ADMIN", fg="white", bg="teal",
                           font=("times new roman", 14, "bold"), bd=5, relief=GROOVE,
    ...
    def admin(self):
        ...
        title_ad = Label(self.Fadmin, text="Billing Software-ADMIN PANNEL", fg="gold", bg='#4863A0', bd=12,
                         relief=GROOVE,
                         font=("times new roman", 20, "bold"), pady=1).pack(fill=X)
        F1_admin = LabelFrame(self.Fadmin, text="cosmatics", font=("time new roman", 15, "bold"), fg="gold",
                              bg='#4863A0',
                              bd=8, relief=GROOVE)
        ...
        # coasmatics wale
        bath_lb_admin = Label(F1_admin, text="Bath Soup:", fg="white", bg='#4863A0',
                              font=("times new roman", 13, "bold")).grid(row=0,
                                                                         column=0,
                                                                         padx=10,
                                                                         pady=6)
        ...
        facewash_lb_admin = Label(F1_admin, text="Face Wash:", fg="white", bg='#4863A0',
                                  font=("times new roman", 13, "bold")).grid(row=3,
                                                                             column=0,
                                                                             padx=10, pady=6)
        facewashadmin_tax_txt = Entry(F1_admin, width=15, textvariable=self.facewashadmin, font=("arial", 10, "bold"),
                                      bd=2,
        ...
        hairgel_lb_admin = Label(F1_admin, text="Hair Gel :", fg="white", bg='#4863A0',
                                 font=("times new roman", 13, "bold")).grid(row=5,
                                                                            column=0,
                                                                            padx=10, pady=6)
        hairgeladmin_tax_txt = Entry(F1_admin, width=15, textvariable=self.hairgeladmin, font=("arial", 10, "bold"),
                                     bd=2,
